...
//     <Button variant="default" size="sm" className="shadow-elegant flex items-center gap-2">
...
//   <a href="/path/to/your-cv.pdf" download className="flex items-center gap-2 w-full justify-center">
//     <Download className="w-4 h-4" />
//     {t("nav.downloadCV")}
//   </a>
// </Button>
